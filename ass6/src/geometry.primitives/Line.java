...
public class Line {
    ...
    public boolean isPointOnLine(Point p) {
        return !((p.getX() - this.start.getX() < -EPSILON && p.getX() - this.end.getX() < -EPSILON)
                || (p.getX() - this.start.getX() > EPSILON && p.getX() - this.end.getX() > EPSILON)
                || (p.getY() - this.start.getY() < -EPSILON && p.getY() - this.end.getY() < -EPSILON)
                || (p.getY() - this.start.getY() > EPSILON && p.getY() - this.end.getY() > EPSILON));
    }
